...
// extending store2.js with store.cache to allow for expiring items
// https://www.npmjs.com/package/store2

// nb. copied from https://raw.githubusercontent.com/nbubna/store/master/src/store.cache.js
// as es6 imports are not currently supported
...
(function (_) {
  ...
  _.when = function (min) {
    ...
    var now = Math.floor(new Date(Date.now()).getTime() / 1000);
